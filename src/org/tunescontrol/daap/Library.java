...
public class Library {
   ...
   public void readTracks(String albumid, TagListener listener) {
      ...
      try {
         ...
         byte[] raw = RequestHelper.request(String.format("%s/databases/%d/containers/%d/items?session-id=%s&meta=dmap.itemname,dmap.itemid,daap.songartist,daap.songalbum,daap.songalbum,daap.songtime,daap.songtracknumber&type=music&sort=album&query='daap.songalbumid:%s'", session.getRequestBase(),
